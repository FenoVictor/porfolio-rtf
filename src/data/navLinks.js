// Liste des liens de navigation affichés dans le composant Navbar.
// `labelKey` pointe vers translations.nav.<labelKey> (voir data/translations.js).
// icon correspond au nom d'un icône exporté par lucide-react.
export const navLinks = [
  { id: 'accueil', labelKey: 'accueil', href: '#accueil', icon: 'Home' },
